...
df.to_csv(
    "./new-resources/Intro To Deep Learning/dl-course-data/bigcheese.csv", index=False
)
...
# Save the dataframe to a csv file
df.to_csv(
    "./new-resources/Intro To Deep Learning/dl-course-data/bigcheese-quadratic.csv",
    index=False,
)
