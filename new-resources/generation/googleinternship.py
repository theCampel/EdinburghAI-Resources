...
df.to_csv(
    "./new-resources/Intro To Deep Learning/dl-course-data/googleinternship_simple.csv",
    index=False,
)
...
# Save the dataframe to a csv file
df.to_csv(
    "./new-resources/Intro To Deep Learning/dl-course-data/googleinternship_big.csv",
    index=False,
)
